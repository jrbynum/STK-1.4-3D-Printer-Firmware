...
#define CUSTOM_MACHINE_NAME "DYI 3D Printer"
...
#define MAX_BED_POWER 206 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 38.04
  #define DEFAULT_bedKi 2.35
  #define DEFAULT_bedKd 147.63
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.5, 100.5, 1600, 876.6 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 800, 800, 16, 50 }
 ...
 */
//RUSTY - for the skr 1.4 using the probe port
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -57.5, +2.5, 0 }
